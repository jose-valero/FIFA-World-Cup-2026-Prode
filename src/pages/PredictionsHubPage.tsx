...
type PredictionView = 'matches' | 'my-predictions';
...
function getPredictionViewFromPath(pathname: string): PredictionView {
...
export function PredictionsHubPage() {
  ...
  const handleChangeView = (_: React.MouseEvent<HTMLElement>, value: PredictionView | null) => {
    ...
    navigate(value === 'matches' ? '/app/predictions/matches' : '/app/predictions/my-predictions');
  };
