-- ============================================================
-- Fix: sync_qualified_teams_into_knockout — WITH RECURSIVE
--
-- El CTE de asignación de mejores terceros usaba `WITH` en lugar
-- de `WITH RECURSIVE`, causando el error:
--   "relation recursive_assign does not exist"
-- y dejando los slots de best_third_place sin poblarse en DB.
-- ============================================================
...
begin
  ...
  if v_group_stage_complete then
    ...
    -- La versión anterior usaba WITH sin RECURSIVE y fallaba con error 42P01.
